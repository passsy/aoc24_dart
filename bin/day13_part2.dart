...
void solveDay13(String input) {
  ...
  for (int i = 0; i < machines.length; i++) {
    ...
    final presses =
        grabPrice(machine, (dx: 10_000_000_000_000, dy: 10_000_000_000_000));
    if (presses != null) {
...
({int a, int b})? grabPrice(Machine machine, Offset offset) {
  final ax = machine.buttonA.dx;
  final ay = machine.buttonA.dy;
  final bx = machine.buttonB.dx;
  final by = machine.buttonB.dy;
  final px = machine.price.x + offset.dx;
  final py = machine.price.y + offset.dy;
