  ...
  group('Day 11', () {
    group('Part 1', () {
      ...
      test('Solution p1', () async {
        final input = '337 42493 1891760 351136 2 6932 73 0';
        final output = await capturePrints(() => day11_part1.solveDay11(input));
    ...
    group('Part 2', () {
      test('Solution p2', () async {
        final input = '337 42493 1891760 351136 2 6932 73 0';
        final output = await capturePrints(() => day11_part2.solveDay11(input));
        checkLastLineNotZero(output);
